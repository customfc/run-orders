...
function renderProsolBody(lines, draftId, { bucket, fnskuAttached } = {}) {
  ...
  if (fnskuAttached) {
    ...
    html += `<li>As each unit is pulled, apply one label <strong>directly over the existing manufacturer barcode</strong> so the FNSKU is the only scannable code.</li>`;
